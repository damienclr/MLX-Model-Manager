...
public class PaligGemmaProcessor: UserInputProcessor {
    ...
    public func prepare(input: UserInput) throws -> LMInput {
        ...
        case 0: throw ModelFactoryError.imageRequired
        case 1: break
        default: throw ModelFactoryError.singleImageAllowed
        }
...
public class PaliGemma: Module, UnifiedModel, KVCacheDimensionProvider {
    ...
    public func prepare(_ input: LMInput, cache: [any KVCache], windowSize: Int?) throws
        -> PrepareResult
    {
        guard let image = input.image else { throw ModelFactoryError.imageRequired }
        guard let mask = input.text.mask else { throw ModelFactoryError.maskRequired }
